test_that("Test that group_by, rowname_col, spanners work correctly", {
  ...
  # no group_by
  wb <- openxlsx2::wb_add_worksheet(wb, "example_1")

  example_1 <- gtcars_8 |>
    gt::gt()

  wb <- gt_to_xlsx(example_1, wb, "example_1")

  # with group_by
  wb <- openxlsx2::wb_add_worksheet(wb, "example_2")

  example_2 <- gtcars_8 |>
    dplyr::group_by(ctry_origin) |>
    gt::gt()

  wb <- gt_to_xlsx(example_2, wb, "example_2")

  # with rowname_col
  wb <- openxlsx2::wb_add_worksheet(wb, "example_3")
  ...
  wb <- gt_to_xlsx(example_3, wb, "example_3")

  # with spanners
  wb <- openxlsx2::wb_add_worksheet(wb, "example_4")
  ...
  wb <- gt_to_xlsx(example_4, wb, "example_4")

  # with multiple spanners
  wb <- openxlsx2::wb_add_worksheet(wb, "example_5")
  ...
  wb <- gt_to_xlsx(example_5, wb, "example_5")

  # with headers
  wb <- openxlsx2::wb_add_worksheet(wb, "example_6")
  ...
  wb <- gt_to_xlsx(example_6, wb, "example_6")

  # with footsource
  wb <- openxlsx2::wb_add_worksheet(wb, "example_7")
  ...
  wb <- gt_to_xlsx(example_7, wb, "example_7")
...
test_that("apply_col_merge is working correclty", {
  ...
  wb <- openxlsx2::wb_add_worksheet(wb, "example_cols_merge")
...
test_that("test that formats works correclty", {
  ...
  wb <- openxlsx2::wb_add_worksheet(wb, "fmt_currency_example")
  ...
  actual_output <- openxlsx2::read_xlsx(temp_file_location)

  expected_file_location <- testthat::test_path("fixtures", "gt_to_xlsx_fmt_currency.xlsx")

  expected_output <- openxlsx2::read_xlsx(expected_file_location)
